 ...
 */
export enum GetCityAnalyticsQueryParamInterval {
    Oneh = "1h",
    TwentyFourh = "24h",
    Sevend = "7d",
    Thirtyd = "30d",
 ...
 */
export enum GetCityAnalyticsQueryParamCountry {
    Af = "AF",
    Al = "AL",
    Dz = "DZ",
    As = "AS",
 ...
 */
export enum GetCityAnalyticsCountry {
    Af = "AF",
    Al = "AL",
    Dz = "DZ",
    As = "AS",
...
export type GetCityAnalyticsResponse = {
     ...
     */
    responseBodies?: Array<GetCityAnalyticsResponseBody> | undefined;
};
...
/** @internal */
export const GetCityAnalyticsQueryParamCountry$ = z.nativeEnum(GetCityAnalyticsQueryParamCountry);
...
/** @internal */
export const GetCityAnalyticsCountry$ = z.nativeEnum(GetCityAnalyticsCountry);
...
export namespace GetCityAnalyticsResponse$ {
    export type Inbound = {
        ...
        responseBodies?: Array<GetCityAnalyticsResponseBody$.Inbound> | undefined;
    };

    export const inboundSchema: z.ZodType<GetCityAnalyticsResponse, z.ZodTypeDef, Inbound> = z
        .object({
            HttpMeta: components.HTTPMetadata$.inboundSchema,
            responseBodies: z
                .array(z.lazy(() => GetCityAnalyticsResponseBody$.inboundSchema))
                .optional(),
        })
        .transform((v) => {
            return {
    ...
    export type Outbound = {
        ...
        responseBodies?: Array<GetCityAnalyticsResponseBody$.Outbound> | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCityAnalyticsResponse> = z
        .object({
            httpMeta: components.HTTPMetadata$.outboundSchema,
            responseBodies: z
                .array(z.lazy(() => GetCityAnalyticsResponseBody$.outboundSchema))
                .optional(),
        })
        .transform((v) => {
            return {
