...
export type GetTopURLsResponse = {
    httpMeta: components.HTTPMetadata;
    /**
     * The top URLs by number of clicks
     */
    responseBodies?: Array<GetTopURLsResponseBody> | undefined;
};
...
/** @internal */
export namespace GetTopURLsResponse$ {
    export type Inbound = {
        HttpMeta: components.HTTPMetadata$.Inbound;
        responseBodies?: Array<GetTopURLsResponseBody$.Inbound> | undefined;
    };

    export const inboundSchema: z.ZodType<GetTopURLsResponse, z.ZodTypeDef, Inbound> = z
        .object({
            HttpMeta: components.HTTPMetadata$.inboundSchema,
            responseBodies: z.array(z.lazy(() => GetTopURLsResponseBody$.inboundSchema)).optional(),
        })
        .transform((v) => {
            return {
                httpMeta: v.HttpMeta,
    ...
    export type Outbound = {
        ...
        responseBodies?: Array<GetTopURLsResponseBody$.Outbound> | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetTopURLsResponse> = z
        .object({
            httpMeta: components.HTTPMetadata$.outboundSchema,
            responseBodies: z
                .array(z.lazy(() => GetTopURLsResponseBody$.outboundSchema))
                .optional(),
        })
        .transform((v) => {
            return {
