...
export namespace GetLinksResponse$ {
    ...
    export const inboundSchema: z.ZodType<GetLinksResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetLinksResponse> = z
        .object({
