...
export namespace CreateLinkResponse$ {
    ...
    export const inboundSchema: z.ZodType<CreateLinkResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateLinkResponse> = z
        .object({
