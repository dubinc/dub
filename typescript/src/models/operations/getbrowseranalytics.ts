 ...
 */
export enum GetBrowserAnalyticsQueryParamInterval {
    Oneh = "1h",
    TwentyFourh = "24h",
    Sevend = "7d",
    Thirtyd = "30d",
 ...
 */
export enum GetBrowserAnalyticsQueryParamCountry {
    Af = "AF",
    Al = "AL",
    Dz = "DZ",
    As = "AS",
...
export type GetBrowserAnalyticsResponseBody = {
    /**
...
export type GetBrowserAnalyticsResponse = {
     ...
     */
    responseBodies?: Array<GetBrowserAnalyticsResponseBody> | undefined;
};
...
/** @internal */
export const GetBrowserAnalyticsQueryParamCountry$ = z.nativeEnum(
...
/** @internal */
export namespace GetBrowserAnalyticsResponseBody$ {
    export type Inbound = {
        browser: string;
        clicks: number;
    };

    export const inboundSchema: z.ZodType<GetBrowserAnalyticsResponseBody, z.ZodTypeDef, Inbound> =
        z
            .object({
                browser: z.string(),
                clicks: z.number(),
...
export namespace GetBrowserAnalyticsResponse$ {
    export type Inbound = {
        ...
        responseBodies?: Array<GetBrowserAnalyticsResponseBody$.Inbound> | undefined;
    };

    export const inboundSchema: z.ZodType<GetBrowserAnalyticsResponse, z.ZodTypeDef, Inbound> = z
        .object({
            HttpMeta: components.HTTPMetadata$.inboundSchema,
            responseBodies: z
                .array(z.lazy(() => GetBrowserAnalyticsResponseBody$.inboundSchema))
                .optional(),
        })
        .transform((v) => {
            return {
    ...
    export type Outbound = {
        ...
        responseBodies?: Array<GetBrowserAnalyticsResponseBody$.Outbound> | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetBrowserAnalyticsResponse> = z
        .object({
            httpMeta: components.HTTPMetadata$.outboundSchema,
            responseBodies: z
                .array(z.lazy(() => GetBrowserAnalyticsResponseBody$.outboundSchema))
                .optional(),
        })
        .transform((v) => {
            return {
