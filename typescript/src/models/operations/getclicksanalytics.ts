...
/** @internal */
export const Country$ = z.nativeEnum(Country);
...
export namespace GetClicksAnalyticsResponse$ {
    ...
    export const inboundSchema: z.ZodType<GetClicksAnalyticsResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetClicksAnalyticsResponse> = z
        .object({
