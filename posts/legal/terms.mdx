...
Subject to these Terms of Service (this "Agreement"), [Dub.sh](/) ("Dub", "we", "us" and/or "our") provides access to Dub's cloud platform as a service (collectively, the "Services"). By using or accessing the Services, you acknowledge that you have read, understand, and agree to be bound by this Agreement.
...
Dub provides an open-source link management tool for modern marketing teams to create, share, and track short links ("the Product"). The Product is accessible at dub.sh and other domains and subdomains controlled by Us (collectively, "the Website").
...
Questions or comments about the Website or these Terms of Service may be directed to our support team at support@dub.sh.
