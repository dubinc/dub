...
2. **Show my links only**: You can now filter your project links with the "Show my links only" filter, which will hide all links created by other users in your organization.

3. **Allow '/' in custom shortlinks**: You can now use '/' in your custom shortlinks. This is useful for creating shortlinks that mimic your website's URL structure. Huge shoutout to [Alex Bass](https://twitter.com/alexhbass) from [Efficient](https://efficient.app/) for this feature request!
