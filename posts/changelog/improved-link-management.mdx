...
3. **Allow '/' in custom shortlinks**: You can now use '/' in your custom shortlinks. This is useful for adding structure to your shortlinks, e.g. `doma.in/r/abc`. Huge shoutout to [Alex Bass](https://twitter.com/alexhbass) from [Efficient](https://efficient.app/) for this feature request!
