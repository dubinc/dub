import { Github, UploadCloud } from "@dub/components/icons";
  ...
  return (
    <MaxWidthWrapper className="mb-20 py-20">
      <div className="mx-auto max-w-md text-center sm:max-w-xl">
        <h2 className="font-display bg-gradient-to-r from-gray-800 via-gray-500 to-gray-800 bg-clip-text text-4xl font-extrabold leading-tight text-transparent sm:text-5xl sm:leading-tight">
          Proudly open-source
        </h2>
