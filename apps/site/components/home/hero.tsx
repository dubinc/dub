...
import { Github, Twitter } from "@dub/components/icons";
...
const Hero = () => {
  return (
    <div className="mx-auto mt-20 mb-10 max-w-md px-2.5 text-center sm:max-w-lg sm:px-0">
      ...
      <h1 className="font-display mt-5 text-5xl font-extrabold leading-tight text-black sm:text-6xl sm:leading-tight">
        Open Source
        <br />
