...
import LoadingDots from "@dub/components/icons/loading-dots";
import { CheckCircleFill } from "@dub/components/icons";
...
export default function Feedback() {
  ...
  return (
    <div className="scrollbar-hide relative h-[420px] overflow-scroll border border-gray-200 bg-white px-7 py-5 sm:rounded-lg sm:border-gray-100 sm:shadow-lg">
