...
import { X } from "@dub/components/icons";
  ...
  return (
    ...
    >
      <div
        ...
        className="scrollbar-hide inline-block max-h-[calc(100vh-150px)] w-full max-w-screen-xl transform overflow-scroll
        bg-gray-50 align-middle shadow-xl sm:rounded-2xl sm:border sm:border-gray-200"
      >
        <button
