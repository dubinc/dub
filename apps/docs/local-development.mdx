...
Install Minlify CLI (for documentation):
...
Web app will be available at [http://localhost:8888](http://localhost:8888).
Docs will be available at [http://localhost:3334](http://localhost:3334).