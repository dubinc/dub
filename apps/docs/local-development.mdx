...
Install Minlify CLI (for docs server):
...
The Web app will be available at [http://localhost:8888](http://localhost:8888).
The Docs will be available at [http://localhost:3334](http://localhost:3334).
