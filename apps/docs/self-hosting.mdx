...
Dub stores project logos and user avatars in via either S3 or S3-compatible services like [Cloudflare R2](https://cloudflare.com/r2).
...
<Frame>![Cloudflare R2 API token](/images/cloudflare-r2-create-api-token.png)</Frame>
