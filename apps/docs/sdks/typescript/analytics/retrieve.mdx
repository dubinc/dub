...
The response object depends on the parameters of `event` and `groupBy`. 

Other than `count`, all other `groupBy` options return an array of objects.

Here is a quick example of how you would retrieve analytics:
