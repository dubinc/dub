...
<ParamField body="groupBy" type="enum">
  The type of analytics to retrieve. Defaults to 'count' if undefined. Available
  options: `count`, `timeseries`, `countries`, `cities`, `devices`, `browsers`,
  `os`, `referers`, `top_links`, `top_urls`, and `trigger`.
</ParamField>
