...
<ParamField body="workspaceId" type="string">
  ...
  workspace](https://dub.co/help/article/how-to-get-workspace-id) you want to
  interact with. Learn how to get your Workspace ID on Dub. Deprecated in favor
  of [workspace API keys](/api-reference/tokens).
</ParamField>
