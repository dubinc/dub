        ...
        <div className="relative flex flex-col items-start space-y-6">
          <label className="w-full text-lg">
            ...
            <input
              ...
              autoComplete="off"
              required
              className="peer mt-2 block w-full rounded-lg border-gray-300 py-4 pl-5 pr-12 text-lg text-gray-900 placeholder-gray-400 focus:border-gray-500 focus:outline-none focus:ring-gray-500"
            />
          </label>
          <div className="flex w-full flex-col space-y-6 md:flex-row md:space-x-4 md:space-y-0">
            <div className="flex w-full basis-2/5 flex-row space-x-4">
              <label className="w-full text-lg">
                ...
                <input
                  ...
                  readOnly
                  disabled
                  className="peer block w-full rounded-lg border-gray-300 bg-gray-100 py-4 pl-5 pr-12 text-lg text-gray-400 focus:border-none focus:outline-none focus:ring-0"
                />
              </label>
              <span className="block pt-11 font-bold">/</span>
            </div>
            <label className="w-full basis-3/5 text-lg">
          ...
          <button
            ...
            } rounded-lg bg-purple-700 px-4 px-8 py-4 font-bold text-white hover:bg-purple-800`}
          >
            {submitting ? (
