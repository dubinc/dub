...
summary: For 7qr Enterprise users, you can securely manage your team's access to 7qr using Okta SAML SSO.
author: steventey
categories:
  - saml-sso
related:
...
For 7qr Enterprise users, you can securely manage your team's access to 7qr using [Okta SAML SSO](https://support.okta.com/help/s/article/okta-saml).
...
In the **General Settings** page, enter "7qr" as the app name, and click **Next**.
...
<CopyBox title="Audience URI (SP Entity ID)" copy="https://saml.7qr.codes" />
...
Copy the metadata URL and return to the 7qr dashboard.
