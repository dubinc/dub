...
summary: Learn how custom QR codes work on 7qr.
author: steventey
categories:
  - link-management
related:
...
As a freemium product, we rely on word of mouth to spread the word about 7qr. Therefore, on 7qr's free plan, you can only use the default QR code logo for your short links.

<Image
  alt="Default QR Code logo on 7qr"
  src="https://d2vwwcvoksz7ty.cloudfront.net/help/free-plan-qrcode.png"
  width={986}
  height={654}
/>

If you'd like to remove the 7qr logo/upload your own, please consider [upgrading to a Pro plan](pro-plan#how-to-upgrade-to-pro) to support us. Thank you!

## How to set a custom QR Code logo?

Once you're on a Pro plan, you can set a custom QR code for your short links.

Your QR code logo is connected to your project's logo on 7qr. To set a custom QR code, you'll need to set your project's logo first by following the steps below:
