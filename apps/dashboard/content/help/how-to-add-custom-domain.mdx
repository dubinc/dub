---
title: How to add a custom domain to 7qr
updatedAt: 2023-07-26
summary: Learn how to add a custom domain to 7qr for free - no credit card required.
author: steventey
categories:
  - custom-domains
  - getting-started
...
7qr is the only link management tool that allows you to add a custom domain for free. On 7qr, you can add as many domains as you want on all plans – including the free plan.

This guide will show you how to add a custom domain to 7qr.

<Prerequisites>

Before you begin, you'll need the following:

- A 7qr account. If you don't have one, you can [create one for free](https://app.7qr.codes/register).
...
First, [log in](https://app.7qr.codes/login) to your 7qr account.

### Don't have a project yet?

1. Navigate to the [7qr Dashboard](https://app.7qr.codes/) and click on the **Create project** button.
...
<Image
  alt="The Add Domain modal in 7qr"
...
<Image
  alt="Setting up DNS records for your domains on 7qr"
...
<Note variant="warning">
  ...
  Cloudflare domains with 7qr](using-cloudflare-domains) for more information.
</Note>
...
Since we use Vercel as the DNS provider for 7qr, you'll need to verify that you own the domain before you can add it to your 7qr project.

<Image
  alt="Verifying domain ownership on 7qr"
...
- **Name**: `_vercel`
- **Value**: `vc-domain-verify=...` (the value will be provided to you on the 7qr dashboard)
...
Domain configuration can take anywhere between 1 to 24 hours to complete. If your domain still doesn't work after 24 hours, please [send us an email](mailto:support@7qr.codes?subject=Domain%20not%20working) and we'll be happy to help you out.
