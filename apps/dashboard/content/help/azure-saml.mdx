...
summary: For 7qr Enterprise users, you can securely manage your team's access to 7qr using Azure AD SAML SSO.
author: steventey
categories:
  - saml-sso
related:
...
For 7qr Enterprise users, you can securely manage your team's access to 7qr using [Azure AD SAML SSO](https://learn.microsoft.com/en-us/azure/active-directory/architecture/auth-saml).
...
In the next screen, click on **Create your own application**. Give your application a **Name** (e.g. "7qr") and click **Create**.
...
<CopyBox title="Identifier (Entity ID)" copy="https://saml.7qr.codes" />

<CopyBox
  title="Reply URL (Assertion Consumer Service URL)"
  copy="https://api.7qr.codes/auth/saml/callback"
/>
...
Scroll down to the 3rd section on the page, **SAML Certificates**. Copy the **App Federation Metadata Url** value and return to the 7qr dashboard.
...
## Step 5: Configure SAML SSO on 7qr
