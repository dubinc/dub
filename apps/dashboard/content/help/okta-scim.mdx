...
summary: For 7qr Enterprise users, you can automatically provision and deprovision users from your Okta directory to 7qr using SCIM Directory Sync.
author: steventey
categories:
  - saml-sso
related:
...
For 7qr Enterprise users, you can automatically provision and deprovision users from your Okta directory to 7qr using [SCIM Directory Sync](https://developer.okta.com/docs/concepts/scim/).
...
Go to the **General** tab of your existing 7qr Okta SAML application that you want to enable SCIM provisioning for. Under **App Settings** click **Edit**.
...
Once you've configured Directory sync, you can assign users to 7qr directly within Okta.
...
They will also be able to sign in to 7qr using Okta SSO.
