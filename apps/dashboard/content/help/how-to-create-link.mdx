---
title: How to create a short link on 7qr?
updatedAt: 2023-07-26
summary: Learn how to create your first short link on 7qr and start tracking your links.
author: steventey
categories:
  - link-management
  - getting-started
...
7qr is also the only link management tool that lets you customize the social media cards for your links, so you can have full control over how your links look when shared on social media.

In this article, we will take a look at how you can leverage these features to create your first short link on 7qr.

## 7qr.sh links vs custom domain links

When you sign up for 7qr, you have the option to choose between the default `7qr.sh` domain or your own custom domain to create short links.

<Image
  alt="Onboarding screen where you can choose between 7qr.sh links or custom domain links"
...
|                        | Default `7qr.sh` links                                            | Custom domain links                                                                                                                                                                       |
| ---------------------- | ----------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| **Branding**           | 7qr branding on the short link                                    | Your own branding on the short link                                                                                                                                                       |
| **Dashboard location** | [app.7qr.codes/links](https://app.7qr.codes/links)                      | Can be found in the project select menu at the top menu bar                                                                                                                               |
...
## The 7qr link builder

There are 3 ways to open the 7qr link builder to create a short link:
...
7qr is the only link management tool that lets you customize the social media cards for your links, so you can have full control over how your links look when shared on social media.
...
<Image
  alt="Masking 'slack.com' with '7qr.sh/slack'"
...
<Image
  alt="With 7qr, you can protect your links with a password"
...
Here's a demo: [7qr.sh/password](https://7qr.sh/password) (password is `dub`)
...
<Image
  alt="Setting an expiration date for your 7qr links"
...
<Image
  alt="Adding comments to your links in the 7qr link builder"
