...
export type FraudReasonCode =
  ...
  | "self_referral.email_match"
  | "self_referral.name_match"
  | "self_referral.email_exact_match"
  | "self_referral.email_domain_variation"
  | "self_referral.email_levenshtein"
  | "self_referral.name_exact_match"
  | "self_referral.name_levenshtein"
...
export const FRAUD_REASON_MESSAGES: Record<FraudReasonCode, string> = {
  // Self-referral reasons
  "self_referral.email_match": "Self-referral detected: email match",
  "self_referral.name_match": "Self-referral detected: name match",
  "self_referral.email_exact_match":
    "Self-referral detected: exact email match",
  "self_referral.email_domain_variation":
    "Self-referral detected: similar email domain",
  "self_referral.email_levenshtein":
    "Self-referral detected: similar email address",
  "self_referral.name_exact_match": "Self-referral detected: exact name match",
  "self_referral.name_levenshtein": "Self-referral detected: similar name",
