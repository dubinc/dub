...
import { PARTNER_POSTBACK_TRIGGERS } from "./constants";

export const postbackSchema = z.object({
  id: z.string(),
  url: z.string(),
  triggers: z.array(z.enum(PARTNER_POSTBACK_TRIGGERS)),
...
export const updatePostbackSchema = z.object({
  ...
  triggers: z.array(z.enum(PARTNER_POSTBACK_TRIGGERS)).optional(),
