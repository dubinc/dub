...
export const trackSaleRequestSchema = z.object({
  ...
  eventName: z
    ...
    .describe(
      "The name of the sale event. It can be used to track different types of event for example 'Purchase completed', 'Subscription created', etc.",
    )
    .openapi({ example: "Purchase completed" }),
  invoiceId: z
    .string()
    .nullish()
    .default(null)
...
export const saleEventSchemaTB = clickEventSchemaTB
  ...
  .and(
    z.object({
      ...
      event_id: z.string(),
      event_name: z.string().default("Purchase completed"),
