...
export const partnersQuerySchema = z
  .object({
    ...
    includeExpandedFields: booleanQuerySchema
      .optional()
      .describe(
        "Whether to include expanded fields on the partner (`reward`, `discount`, `online-presence`).",
      )
...
export const partnersExportQuerySchema = partnersQuerySchemaExtended
...
export const partnersCountQuerySchema = partnersQuerySchemaExtended
  .omit({
    sortBy: true,
    sortOrder: true,
    page: true,
...
export const EnrolledPartnerBasicSchema = PartnerSchema.pick({
  id: true,
  name: true,
  email: true,
  image: true,
...
export const EnrolledPartnerSchema = EnrolledPartnerBasicSchema.extend({
  ...
  totalCommissions: z
    .number()
    .default(0)
    .describe("The total commissions paid to the partner for their referrals."),
  netRevenue: z
    .number()
    .default(0)
