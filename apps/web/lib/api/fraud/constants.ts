...
export const FRAUD_RULES: FraudRuleInfo[] = [
  // Conversion event rules
  {
    ...
    description:
      "Partner's email matches a customer's email, shares the same email domain, or the customer's domain matches a previously referred customer.",
...
// Common free email provider domains excluded from domain-based fraud matching to avoid false positives.
