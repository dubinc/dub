...
export default function Layout({ children }: PropsWithChildren) {
  return (
    <>
      ...
      <div className="relative flex min-h-screen min-h-[100dvh] w-full flex-col items-center overflow-hidden md:justify-between">
        ...
        <div className="w-full flex-1 overflow-y-auto md:flex-none md:overflow-visible">
          <div className="w-full px-5 pb-8 pt-8 lg:px-0 md:py-16">
            {children}
          </div>
        </div>
