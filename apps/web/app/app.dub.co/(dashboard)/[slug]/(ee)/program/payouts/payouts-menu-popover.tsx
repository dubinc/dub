...
import { useExportPayoutsModal } from "@/ui/modals/export-payouts-modal";
import { ThreeDots } from "@/ui/shared/icons";
import { Button, Download, IconMenu, Popover } from "@dub/ui";
import { useState } from "react";

export function PayoutsMenuPopover() {
  const [openPopover, setOpenPopover] = useState(false);

  const { ExportPayoutsModal, setShowExportPayoutsModal } =
    useExportPayoutsModal();
            ...
            <div className="grid gap-px p-2">
              ...
              <button
                onClick={() => {
                  ...
                  setShowExportPayoutsModal(true);
                }}
