    ...
    <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
      {QR_TYPES.map((qr) => (
        <button
          ...
          className="bg-primary-200 hover:bg-primary-300 flex h-[81px] w-full max-w-[171.5px] cursor-pointer flex-col items-center justify-center gap-2 rounded-lg px-[6px] py-3 transition focus:outline-none md:h-24 md:max-w-[242px] md:gap-3 md:px-2 lg:max-w-[272px]"
        >
