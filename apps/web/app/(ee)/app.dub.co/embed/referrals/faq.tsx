      ...
      <Accordion type="single" collapsible>
        {items.map((item, idx) => (
          <AccordionItem key={idx} value={idx.toString()}>
            ...
            <AccordionContent>
              <BlockMarkdown className="dark:prose-invert dark:prose-a:text-neutral-400 dark:hover:prose-a:text-neutral-300 dark:marker:prose-ul:text-neutral-400 text-content-subtle py-2 text-left text-sm sm:text-base">
                {item.content}
              </BlockMarkdown>
            </AccordionContent>
          </AccordionItem>
