...
import { publishPendingJobs } from "@/lib/jobs/outbox";
...
// GET /api/cron/queue/retry – republish jobs that failed to publish to QStash
// at dispatch time; rows are deleted on successful publish
