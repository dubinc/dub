...
export default function Onboarding() {
  return (
    <div className="relative mx-auto mt-10 flex w-full max-w-sm flex-col items-center px-3 text-center md:px-8">
      ...
      <div className="mt-10 flex w-full flex-col items-center md:mt-16 lg:mt-20">
        ...
        <div className="animate-slide-up-fade mt-10 w-full [--offset:10px] [animation-delay:500ms] [animation-duration:1s] [animation-fill-mode:both]">
          <OnboardingForm />
        </div>
      </div>
    </div>
