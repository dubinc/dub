export const GET_QR_FEATURES = [
  ...
  },
  {
    ...
    content:
      "Get a QR code that looks sharp and professional no matter where you use it. Whether it’s on your phone screen, printed flyer or banner, the code stays clear and scan-ready.",
