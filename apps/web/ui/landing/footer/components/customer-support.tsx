...
export const CustomerSupport = () => (
  <div className="text-neutral-default mr-20 max-md:mt-6">
    <p className="mb-4 text-lg font-semibold">Customer Support</p>
    <span className="text-base font-medium">Available 24/7/365</span>
    <Link
      className="mt-3 flex h-[44px] w-full items-center justify-center gap-2.5 rounded-md border border-black px-6 py-2.5 text-sm font-medium"
