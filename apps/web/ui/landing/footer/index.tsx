...
export const Footer = () => (
  <footer className="mt-auto w-full">
    <div className="bg-primary-lighter mt-10 w-full py-6 md:mt-16 lg:py-12">
      <div className="mx-auto flex w-full max-w-7xl flex-col max-[1320px]:px-6 max-md:px-4">
        ...
        <div className="flex w-full flex-col justify-between gap-4">
          <Payments />
          <p className="text-neutral-lighter text-left text-sm">
            © GetQR - 2025. All rights reserved. Create your own QR codes and
            promote your business or idea. <br />
            <br />
