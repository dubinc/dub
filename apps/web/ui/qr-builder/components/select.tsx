  ...
  return (
    <DropdownMenu.Root>
      <DropdownMenu.Trigger>
        <div
          className={cn(
            "border-border-300 flex h-11 w-full cursor-pointer items-center justify-between gap-3.5 rounded-md border bg-white px-3 text-sm text-neutral-200 transition-colors",
