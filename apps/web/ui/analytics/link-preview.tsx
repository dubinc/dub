...
export default function LinkPreviewTooltip({ data }: { data: LinkProps }) {
  ...
  return (
    <div className="relative flex w-[28rem] items-center gap-x-2 px-neutral-2">-neutral-
        ...
        <div className="min-w-0 shrink grow-0 text-gray-950">
          <div className="flex items-center gap-2">
            <a
              ...
              title={linkConstructor({ domain, key, pretty: true })}-neutral-
        ...
        <div className="flex min-w-0 items-center gap-1 text-sm">
          ...
          {url ? (
            <a
              href={url}
              target="_blank"
              rel="noopener noreferrer"-neutral--neutral-
              title={url}
