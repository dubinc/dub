      ...
      <div className="relative z-0 mx-auto w-full">
        ...
        >
          ...
          <g clipPath={`url(#${id}-a)`}>
            ...
            <path fill="#F5F5F5" d="M6.645 65.836h110.612v61.451H6.645z"></path>
            <g clipPath={`url(#${id}-f)`}>
              <path
                fill="#DBEAFE"
          ...
          <defs>
            ...
            <clipPath id={`${id}-e`}>
              <path fill="#fff" d="M105.991 41.497h6.145v6.145h-6.145z"></path>
            </clipPath>
            <clipPath id={`${id}-f`}>
              <path
                fill="#fff"
            ...
            <clipPath id={`${id}-v`}>
              <path fill="#fff" d="M654.701 73.976h10.242v10.242H654.7z"></path>
            </clipPath>
            <clipPath id={`${id}-y`}>
              <path
                fill="#fff"
