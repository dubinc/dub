...
type FormData = {
  ...
  applicationScreeningPrompt: string;
};
...
function ApplicationSettingsSheetContent({
  ...
  const {
    ...
    defaultValues: {
      ...
      applicationScreeningPrompt: program?.applicationScreeningPrompt ?? "",
    },
  });
    ...
    if (isDirty) {
      requests.push(
        executeAsync({
          ...
          applicationScreeningPrompt: data.applicationScreeningPrompt,
        ...
        {(!showMarketplace || activeSection === "applications") && (
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <div>
                <label
                  htmlFor="applicationScreeningPrompt"
              ...
              <textarea
                id="applicationScreeningPrompt"
                {...register("applicationScreeningPrompt", { maxLength: 2000 })}
                rows={3}
                maxLength={2000}
                placeholder="Partners that offer SEO, backlink, paid advertising, or affiliate marketing services."
                onKeyDown={handleKeyDown}
                className={cn(
                  "block w-full rounded-lg border border-neutral-200 bg-white text-neutral-900 placeholder-neutral-400 focus:border-neutral-500 focus:outline-none focus:ring-neutral-500 sm:text-sm",
                  errors.applicationScreeningPrompt &&
