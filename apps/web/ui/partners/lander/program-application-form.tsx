...
import { programApplicationFormFieldSchema, programApplicationFormFieldsSchema, programApplicationFormFieldsWithValuesSchema, programApplicationFormLongTextFieldWithValueSchema, programApplicationFormMultipleChoiceFieldSchema, programApplicationFormMultipleChoiceFieldWithValueSchema, programApplicationFormSelectFieldWithValueSchema, programApplicationFormShortTextFieldWithValueSchema, programApplicationFormWebsiteAndSocialsFieldWithValueSchema } from "@/lib/zod/schemas/program-application-form";
...
export function ProgramApplicationForm({
  ...
  >;
  group: Pick<GroupWithFormDataProps, "id" | "applicationFormData">;
  preview?: boolean;
}) {
