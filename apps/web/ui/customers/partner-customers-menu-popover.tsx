...
import { useExportPartnerCustomersModal } from "@/ui/modals/export-partner-customers-modal";
import { ThreeDots } from "@/ui/shared/icons";
import { Button, Download, IconMenu, Popover } from "@dub/ui";
import { useState } from "react";

export function PartnerCustomersMenuPopover() {
  const [openPopover, setOpenPopover] = useState(false);

  const { ExportPartnerCustomersModal, setShowExportPartnerCustomersModal } =
    useExportPartnerCustomersModal();
            ...
            <div className="grid gap-px p-2">
              ...
              <button
                onClick={() => {
                  ...
                  setShowExportPartnerCustomersModal(true);
                }}
