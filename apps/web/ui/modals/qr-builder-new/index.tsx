...
import { useNewQrOperations, useQrData } from "@/ui/qr-builder-new/hooks/use-qr-operations";
...
export function useQRBuilderNew(data?: {
  qrData?: TQrServerData;
  initialStep?: number;
}) {
  const { user } = useUser();
  const { qrData, initialStep } = data ?? {};
  ...
  }, [qrData, showQRBuilderModal, setShowQRBuilderModal, initialStep, user]);
