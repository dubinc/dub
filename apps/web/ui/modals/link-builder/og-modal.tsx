  ...
  const {
    ...
    onError: (error) => {
      if (error.message.includes("Upgrade to Pro")) {
        toast.custom(() => (
          <UpgradeRequiredToast
            title={t("usage-limit-exceeded-duplicate")}
            message={error.message}
          />
        ));
      } else {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <ProBadgeTooltip
                content={
                  <SimpleTooltipContent
                    title={t("customize-link-preview-description")}
                    cta="Learn more."
              ...
              <Tooltip
                content={
                  <div className="px-2 py-1 text-xs text-gray-700">
                    {t("quick-open-instruction", {
                      component0: (
                        <strong className="font-medium text-gray-950">
                          {t("quick-open-instruction_component0")}
                        </strong>
                      ),
                    })}
                  </div>
              ...
              <FileUpload
                ...
                content={
                  <>
                    ...
                    <p className="mt-1">{t("recommended-image-dimensions")}</p>
                  </>
                }
              />
            </div>
