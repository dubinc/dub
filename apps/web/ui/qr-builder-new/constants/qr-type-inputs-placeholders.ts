...
export const QR_INPUT_PLACEHOLDERS = {
  ...
  WHATSAPP_MESSAGE: "Hi GetQR team! 👋 I saw your awesome QR code platform and I'd love to start using it for my restaurant. Digital menus sound perfect — physical ones are just sooo outdated! Can you help me get set up?",
