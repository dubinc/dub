...
import { wifiQRSchema, WifiQRFormData } from "../../validation/schemas";
...
export const WifiForm = forwardRef<WiFiFormRef, WiFiFormProps>(
  ({ onSubmit, defaultValues, initialData }, ref) => {
    ...
    const formDefaults = getDefaultValues({
      qrName: QR_NAME_PLACEHOLDERS.WIFI,
      networkName: "",
      networkPassword: "",
          ...
          <form className="flex w-full flex-col gap-4">
            ...
            <div className="flex w-full flex-col gap-2">
              <Flex gap="1" align="center">
                <label className="text-neutral text-sm font-medium">Network Security Type</label>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Select
                    ...
                    value={WIFI_ENCRYPTION_TYPES.find(option => option.id === field.value) || null}
            ...
            <div className="bg-secondary-50 border-secondary-200 flex items-start gap-3 rounded-lg border p-3">
              ...
              <Text size="2" className="text-secondary">
                Not sure where to find this info? Look at the label on your router — it usually lists your WiFi name, password, and security type.
              </Text>
            </div>
          </form>
        </div>
