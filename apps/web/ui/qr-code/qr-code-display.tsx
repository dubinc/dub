import {
  qrCodeDisplayProperties,
  QrCodesDisplayContext,
  QrCodesViewMode,
} from "@/ui/qr-code/qr-codes-display-provider.tsx";
import {
  Button,
  Popover,
  Switch,
...
import LinkSort from "./qr-code-sort";
...
export default function QrCodeDisplay() {
  ...
  return (
        ...
        <div className="w-full divide-y divide-neutral-200 text-sm md:w-80">
            ...
            {[
              ...
              return (
                <button
                  ...
                  onClick={() => setViewMode(id as QrCodesViewMode)}
          ...
          <div className="p-4">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {qrCodeDisplayProperties.map((property) => {
    ...
    >
      <Button
        variant="secondary"
        className="border-neutral-200/20 hover:bg-white data-[state=open]:border-neutral-200/40 data-[state=open]:ring-neutral-200/40 [&>div]:w-full"
