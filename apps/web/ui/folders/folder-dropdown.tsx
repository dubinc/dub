...
export const FolderDropdown = ({
  ...
  return (
    <>
      ...
      >
        <button className="group flex max-w-60 items-center gap-2 rounded-lg px-2 py-1 transition-colors hover:bg-neutral-100 active:bg-neutral-200 data-[state=open]:bg-neutral-100">
