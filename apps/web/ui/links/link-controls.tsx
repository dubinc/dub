    ...
    <div className="flex justify-end">
      <div
        className={cn(
          ...
          "divide-transparent border-transparent sm:group-hover/card:divide-gray-200 sm:group-hover/card:border-gray-200", // Only show divider on mobile or when hovered
          "w-[30px] transition-[width] duration-300 sm:w-[43px] sm:group-hover/card:w-[124px]",
        )}
      >
        <LinkQRModal />
        <AddEditLinkModal />
