    ...
    <>
      ...
      <MaxWidthWrapper className="flex flex-col space-y-3 py-3">
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-7">
          <div className="scrollbar-hide sticky top-32 col-span-2 hidden max-h-[calc(100vh-150px)] self-start overflow-auto rounded-lg border border-gray-200 bg-white shadow lg:block">
            <Suspense>
              <LinkFilters />
            </Suspense>
          </div>
