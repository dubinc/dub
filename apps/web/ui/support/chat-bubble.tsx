      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="pointer-events-auto mb-4 flex h-[660px] max-h-[calc(100vh-6rem)] w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-2xl shadow-[inset_0_0_0_1px_rgba(0,0,0,0.08)] sm:w-[560px]"
          >
