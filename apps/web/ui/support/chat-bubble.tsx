      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="pointer-events-auto mb-4 flex h-[660px] max-h-[calc(100vh-6rem)] w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-2xl outline outline-1 -outline-offset-1 outline-black/15 sm:w-[560px]"
          >
