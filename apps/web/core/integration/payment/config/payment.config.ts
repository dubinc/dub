...
const priceConfig = {
  ...
  paymentPlan: {
    DEFAULT: {
      PRICE_MONTHLY_FOR_QUARTER_PLAN: 3999,
      PRICE_MONTHLY_FOR_HALF_YEAR_PLAN: 2999,
      PRICE_MONTHLY_FOR_HALF_YEAR_PLAN_PREV: 3999,
      PRICE_MONTHLY_FOR_YEAR_PLAN: 1999,
      PRICE_MONTHLY_FOR_YEAR_PLAN_PREV: 3999,
    },
  },
};
