...
import useViewportSize from "@dub/lib/hooks/use-viewport-size";
    ...
    <>
      ...
      >
        ...
        <PopoverPrimitive.Content
          sideOffset={4}
          align={align}
          className="animate-slide-up-fade z-20 hidden items-center rounded-md border border-gray-200 bg-white drop-shadow-lg md:block"
        >
          {content}
        </PopoverPrimitive.Content>
      </PopoverPrimitive.Root>
