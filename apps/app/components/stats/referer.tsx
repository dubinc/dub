...
import { Link, LoadingDots } from "@dub/components/icons";
import { StatsProps, processRefererData } from "@/lib/stats";
import { nFormatter } from "@dub/lib/utils";
...
export default function Referer({ data: rawData }: { data: StatsProps }) {
  ...
  return (
    <div
      className="scrollbar-hide relative h-[420px] overflow-scroll border border-gray-200 bg-white px-7 py-5  sm:rounded-lg sm:border-gray-100 sm:shadow-lg"
