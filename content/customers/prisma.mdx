...
With [Prisma Accelerate](https://www.prisma.io/data-platform/accelerate) and [Prisma Pulse](https://www.prisma.io/data-platform/pulse), they're also providing new tools to build modern applications with great developer experience.
