---
title: How Prisma Uses 7qr to Improve Insights for Pris.ly links
publishedAt: 2023-09-07
summary: Prisma recently migrated their pris.ly short links to 7qr. Learn why they chose 7qr and how it has helped them better understand their users' needs.
...
In fact, 7qr itself uses the Prisma ORM under the hood to handle database queries and migrations – here is our [Prisma Schema](https://github.com/steven-tey/dub/blob/main/prisma/schema.prisma) file, fully open-source as well!
...
Earlier this month, [Petra](https://twitter.com/petradonka) from the Prisma team reached out with one simple request – they wanted to migrate their existing `pris.ly` short links to 7qr.
...
7qr was the perfect solution for Prisma's use case – given its ease of use and powerful analytics.

In less than a day, Prisma was able to migrate all 250+ of their existing `pris.ly` links to 7qr, and the value prop was clear from the start:

1. **Analytics on each link**: 7qr provides detailed analytics on each link, including the number of clicks over time, location data, device data, and more.
2. **Easy to create new links**: 7qr provides a simple UI to create new links, along with useful features such as [tags](/help/article/how-to-use-tags) to help organize links.
3. **Smooth UX and instant updates**: With 7qr, Prisma can now [easily create short links](/help/article/how-to-create-link) that are instantly available to use – no more waiting for 10 seconds for the link to be deployed.
...
<Quote
  ...
  company="Prisma"
  companySrc="https://d2vwwcvoksz7ty.cloudfront.net/customers/prisma-logo.png"
  text="7qr is a fantastic product – the value prop was clear in just 5 mins of us going live with it, when the first short link was created."
/>

## The results: Smoother UX for the entire Prisma team

Since migrating to 7qr, Prisma has been able to quickly create new links and track the performance of each link. This gave them insight into which links are most used and how they can make even better use of those resources.
...
<Quote
  ...
  company="Prisma"
  companySrc="https://d2vwwcvoksz7ty.cloudfront.net/customers/prisma-logo.png"
  text="7qr makes it so much easier to quickly create links when helping users on Twitter, Slack, or Discord – as well as track the performance of those links. Really awesome product!"
/>

As an Enterprise customer on 7qr, Prisma has also been leveraging 7qr's [SAML/SSO feature](/help/category/saml-sso) to manage access to their links. This has been especially useful for Prisma, as they have been able to easily manage access to links for their entire team.
