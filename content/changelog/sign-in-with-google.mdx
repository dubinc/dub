...
We've also added a "Delete Account" feature to the [settings page](https://app.dub.sh/settings). You can now delete your Dub account and all associated data, if that's what you want to do.
