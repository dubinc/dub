...
Dub provides an open-source link management tool for modern marketing teams to create, share, and track short links ("the Product"). The Product is accessible at 7qr.codes and other domains and subdomains controlled by Us (collectively, "the Website").
