...
- A Dub account. If you don't have one, you can [create one for free](https://app.7qr.codes/register).
...
First, [log in](https://app.7qr.codes/login) to your Dub account.

### Don't have a project yet?

1. Navigate to the [Dub Dashboard](https://app.7qr.codes/) and click on the **Create project** button.
