---
title: How to use Tags on 7qr
updatedAt: 2023-07-26
summary: Learn more about what a "Tag" is and how you can use it to better manage your links on 7qr.
author: steventey
categories:
  - link-management
related:
...
Tags are a great way to organize your links on 7qr. You can use tags to group links together and make it easier to find them later.

<Image
  alt="Using tags to organize links on 7qr"
...
Currently, we only support assigning one tag to a link. If you're interested in the ability to assign multiple tags to a link, please let us know by [creating an issuue here](https://7qr.sh/issues).
...
Learn more about the Pro plan on 7qr [here](pro-plan).

<Note variant="warning">
  **Note**: You cannot create any tags when using `7qr.sh` links.
</Note>
