...
summary: How you can migrate from Short.io to 7qr in a few simple steps.
author: steventey
categories:
  - migrating
  - getting-started
...
## How to migrate from Short.io to 7qr

If you're looking to migrate from Short.io to 7qr, we've built a custom migration tool that will help you migrate your links in a few simple steps.
...
Select the domains you want to migrate and click **Confirm import**. In just a few seconds, all your links will be migrated to 7qr.
...
Here's a list of attributes that are migrated from Short.io to 7qr:
...
7. Archived status
8. Link title (as part of 7qr's [Custom Social Media cards](how-to-create-link#custom-social-media-cards) feature)
...
2. Link tags
3. Link 404 URL
4. Link redirect type (7qr uses 307 redirects for all links)
5. Link cloaking (7qr only offers link cloaking for the root domain of your project)

If there are any attributes that you'd like to see migrated, please [send us an email](mailto:support@7qr.codes?subject=Short.io%20migration%20feedback) and let us know!
