...
summary: For 7qr Enterprise users, you can automatically provision and deprovision users from Azure AD to 7qr using SCIM Directory Sync.
author: steventey
categories:
  - saml-sso
related:
...
For 7qr Enterprise users, you can automatically provision and deprovision users from your Azure Active Directory (AD) to 7qr using [SCIM Directory Sync](https://learn.microsoft.com/en-us/azure/active-directory/architecture/sync-scim).
...
## Step 1: Configure Directory Sync on 7qr
...
<Image
  alt="Directory Sync section on the 7qr Dashboard"
...
This will generate a Directory Sync connection for your 7qr project, and return 2 values, which will be needed in Step 2:
...
Click on the **Provisioning** tab of your existing 7qr Okta SAML application that you want to enable SCIM provisioning for.
...
Congratulations! You've successfully configured SCIM provisioning for your 7qr project.

## Step 3: Assign Users

Once you've configured Directory sync, you can assign users to 7qr directly within Azure AD.
...
Your assigned users should now receive an invitation email to join your 7qr project.
...
<Note variant="warning">
  ...
  invitation email and be able to join your 7qr project.
</Note>

They will also be able to sign in to 7qr using Azure AD SSO.
