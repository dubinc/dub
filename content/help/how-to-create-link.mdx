...
8. **Device Targeting**: Set a custom destination URL for iOS and Android devices. [Learn more](#device-targeting-ios--android).
9. **Social Previews**: See how your links will look when shared on social media.
