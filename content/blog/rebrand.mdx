...
Our rebrand is more of a facelift than a complete overhaul. We're still the same Dub you know and love, but with a new domain. We will still be using `7qr.sh` as the default short link domain on Dub, and all existing `7qr.sh` links will continue to work as usual.
...
Dub is here to stay and we're committed to making it the best link shortener for everyone, everywhere. We invite you to join us on this journey by [creating a free account](https://app.7qr.codes/register) today.
