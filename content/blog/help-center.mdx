...
The best part: **It can be accessed anywhere on Dub – even inside the [Dub dashboard](https://app.7qr.codes) itself**! All you need to do is enter the magic command: `CMD+K` (or `CTRL+K` on Windows). Go ahead and give it a try!
...
If you have any questions or feedback about the Help Center, feel free to [send us an email](mailto:support@7qr.sh?subject=Feedback%20on%20the%20Dub%20Help%20Center) or [reach out to us on Twitter](https://twitter.com/dubdotco).
