...
export default function PartnerUserInvited({
  ...
  url = "http://partners.localhost:8888/api/auth/magic-link/verify?token=xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx&callbackURL=http%3A%2F%2Fpartners.localhost%3A8888%2Finvite",
  partnerName = "Acme",
