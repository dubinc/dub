...
export default function DubStartupProgramAnnouncement({
  ...
  return (
    <Html>
      ...
      <Preview>
        Get 50% off our yearly Advanced plan + 25% off in year 2 – our biggest
        discount ever.
      </Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="email-container mx-auto my-10 max-w-[600px] px-10 py-5">
            ...
            <Section className="mb-6">
              <Link
                href="https://ship.dub.co/startups"
                style={{ textDecoration: "none" }}
              >
                <Img
                  src="https://assets.dub.co/og/startups.jpg"
                  width={560}
                  height={320}
                  alt="Dub Startup Program"
              ...
              <Text className="mx-0 my-2 text-sm leading-6 text-neutral-600">
                We're excited to launch our Startup Program, which offers a 50%
                discount on our yearly Advanced plan + 25% off in year 2 – our
                biggest discount ever.
              </Text>

              <Text className="mx-0 my-2 text-sm leading-6 text-neutral-600">
                The Advanced plan also gives you access to additional features,
                including:
              </Text>
              ...
              <Text className="mx-0 mb-1 mt-0 pl-4 text-sm leading-6 text-neutral-600">
                ...
                +{" "}
                <Link
                  href="https://ship.dub.co/group-move-rules"
                  className="font-medium text-black underline"
                >
                  Group move rules
                </Link>
              ...
              <Text className="mx-0 mb-4 mt-0 pl-4 text-sm leading-6 text-neutral-600">
                ...
                +{" "}
                <Link
                  href="https://ship.dub.co/messaging-partners"
                  className="font-medium text-black underline"
                >
                  Messaging center
                </Link>
              ...
              <Section className="mt-4 text-center">
                ...
                >
                  Apply to the Dub Startup Program
                </Link>
              </Section>
            </Section>
