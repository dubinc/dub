...
export function CardListPagination({
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-4 left-1/2 flex w-full max-w-[768px] -translate-x-1/2 items-center justify-between rounded-xl border border-gray-200 bg-white px-4 py-3.5 text-sm leading-6 text-gray-600 [filter:drop-shadow(0_5px_8px_#222A351d)]">
        <div>
