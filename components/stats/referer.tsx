...
import { processRefererData, StatsProps } from '@/lib/stats';
...
export default function Referer({ data: rawData }: { data: StatsProps }) {
  ...
  return (
    ...
    >
      ...
      <div className={data.refererData && data.refererData.length > 0 ? 'grid gap-4' : 'h-[300px] flex justify-center items-center'}>
        {data.refererData ? (
