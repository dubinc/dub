  ...
  return (
    <div className={styles.card}>
          ...
          <div className="flex items-center space-x-2">
            <a href={authorUrl} target="_blank" rel="noreferrer">
              <BlurImage
                ...
                className="h-10 w-10 overflow-hidden rounded-full transition-all ease-in-out hover:scale-105 hover:shadow-md"
              />
            </a>
            <div>
              <a
      ...
      <div className="flex justify-center space-x-6 text-sm text-gray-500">
        <a
          className="group flex items-center space-x-1 hover:text-red-600"
          href={likeUrl}
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          className="group flex items-center space-x-1 hover:text-blue-600"
          href={replyUrl}
          target="_blank"
          rel="noreferrer"
        >
