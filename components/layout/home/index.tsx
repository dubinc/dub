          ...
          <div className="h-16 flex justify-between items-center">
            ...
            {session ? (
              <a
                ...
                className="py-1.5 px-5 bg-black dark:bg-white dark:hover:bg-slate-900 dark:hover:text-slate-200 hover:bg-white rounded-full border border-black dark:border-slate-200 text-sm text-white dark:text-slate-900 hover:text-black transition-all"
              >
                Dashboard
              </a>
            ) : (
