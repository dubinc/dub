...
export default function LinkPagination() {
  ...
  return (
    <div className="sticky bottom-0 z-10 mt-4 flex h-20 scale-[1.02] flex-col items-center justify-center space-y-2 rounded-t-md border border-gray-200 bg-white shadow-lg">
